...
class System
{
  ...
  public:
    ...
    System(const std::string &strVocFile, const std::string &strSettingsFile, const eSensor sensor, bool use_loop_closing = true);
    ...
    // Save all camera trajectory in the TUM RGB-D dataset format.
    // Call first Shutdown()
