...
void Viewer::Run()
{
    ...
    pangolin::CreateWindowAndBind("Object SLAM: Map Viewer", 1024, 768);
    ...
    pangolin::Var<bool> menuFollowCamera("menu.Follow Camera", false, true); // NOTE first value is default value
